  ...
  const renderBody = (rowData, field) => {
    if (field === 'id_Usuario') {
      ...
      return usuario ? `${usuario.nombre_Usuario} ${usuario.apellidoP_Usuario} ${usuario.apellidoM_Usuario}` : '';
        ...
        return solicitan ? `${solicitan.nombre_Solicitante} ${solicitan.apellidoP_Solicitante} ${solicitan.apellidoM_Solicitante}` : '';
      ...
      >          
        <div className="formgrid grid">
            <div className="field col">
                <label htmlFor="Usuarios" className="font-bold">Usuario*</label>
                <Dropdown
                id="Usuarios"
                value={id_Usuario} 
                ...
                className={classNames({ 'p-invalid': frmEnviado && !id_Usuario })}
                />
                {frmEnviado && !id_Usuario && (
                    <small className="p-error">Se requiere el Usuario.</small>
                )}
            </div>
            <div className="field col">
